...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/PhaxioSwiftAlamofire/PhaxioSwiftAlamofire.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PhaxioiOS/PhaxioiOS.framework"
